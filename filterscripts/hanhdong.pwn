// Filterscript Hanh Dong duoc viet hoa boi Nicky Z
...
public OnFilterScriptInit()
{
	...
	"~w~An ~r~~k~~PED_SPRINT~ ~w~de dung hanh dong lai");
...
CMD:ngoighe(playerid, params[])
{
    if(!IsAblePedAnimation(playerid)) return 1;
    switch(strval(params))
    {
    case 1: PlayAnimEx(playerid, "Attractors","Stepsit_in",4.1,0,0,0,1,0,1);
    case 2: PlayAnimEx(playerid, "CRIB","PED_Console_Loop", 4.0, 1, 0, 0, 0, 0, 1);
    case 3: PlayAnimEx(playerid, "INT_HOUSE","LOU_In", 4.1,0,0,0,1,0,1);
    ...
    case 7: PlayAnimEx(playerid, "ped","SEAT_down", 4.1,0,0,0,1,0,1);
    default: SendClientMessage(playerid, COLOR_WHITE, "Su dung: /ngoighe [1-7]");
    }
    return 1;
}
